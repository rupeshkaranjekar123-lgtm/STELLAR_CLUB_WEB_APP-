...
export default function Restaurant() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      {/* Hero */}
      <section className="relative w-full min-h-[70vh] py-32 flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center px-4 fade-in mt-12 max-w-4xl mx-auto">
          <div className="flex justify-center mb-6">
            <Coffee className="w-12 h-12 text-[#C9A14A]" />
          </div>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif text-white mb-6 leading-tight drop-shadow-xl">
            A Culinary <br className="hidden md:block"/> <span className="text-[#C9A14A]">Masterpiece</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="#reservation"
              className="group inline-flex items-center gap-3 bg-[#C9A14A] text-black px-10 py-4 rounded-sm font-semibold uppercase tracking-widest text-sm hover:scale-105 hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] transition-all duration-300"
            >
              Reserve Table
      ...
      <section className="py-24 px-6 bg-[#0A0A0A]">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="group">
              <Utensils className="w-10 h-10 text-[#C9A14A] mx-auto mb-6 group-hover:scale-110 transition-transform" />
            ...
            <div className="group">
              <Star className="w-10 h-10 text-[#C9A14A] mx-auto mb-6 group-hover:scale-110 transition-transform" />
            ...
            <div className="group">
              <MapPin className="w-10 h-10 text-[#C9A14A] mx-auto mb-6 group-hover:scale-110 transition-transform" />
          ...
          <div className="glass-card p-10 md:p-14 border border-[#C9A14A]/20 relative overflow-hidden text-center">
            ...
            <form className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
              ...
              <div className="space-y-2">
                ...
                <input type="date" className="w-full bg-black/50 border border-white/10 rounded-sm px-4 py-3 text-white focus:outline-none focus:border-[#C9A14A]/50 transition-colors" />
              </div>
              <div className="space-y-2">
