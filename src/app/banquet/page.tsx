      ...
      <section className="relative w-full min-h-[70vh] py-32 flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center px-4 fade-in mt-12 max-w-4xl mx-auto">
          <div className="flex justify-center mb-6">
            <Award className="w-12 h-12 text-[#C9A14A]" />
          </div>
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12 text-center">
            {[
              ...
              { icon: <Camera className="w-8 h-8 text-[#C9A14A] mb-4 mx-auto" />, title: 'Decor', desc: 'In-house Support' },
              { icon: <Music className="w-8 h-8 text-[#C9A14A] mb-4 mx-auto" />, title: 'Catering', desc: 'Premium Menus' }
            ].map((item, i) => (
              <div key={i} className="glass-card p-8 border border-white/5 hover:border-[#C9A14A]/30 transition-all duration-300">
                {item.icon}
          ...
          <div className="glass-card p-6 sm:p-10 md:p-14 border border-[#C9A14A]/20 relative overflow-hidden text-center">
            ...
            <form className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
              ...
              <div className="space-y-2">
                ...
                <input type="number" placeholder="Number of guests" className="w-full bg-black/50 border border-white/10 rounded-sm px-4 py-3 text-white focus:outline-none focus:border-[#C9A14A]/50 transition-colors" />
              </div>
