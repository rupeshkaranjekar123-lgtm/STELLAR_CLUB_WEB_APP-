    ...
    <main className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 flex flex-col items-center text-center mt-12 fade-in">
          ...
          <div className="flex flex-col items-center gap-5 mb-8">
            ...
            <svg width="42" height="38" viewBox="0 0 42 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-[0_0_8px_rgba(212,175,55,0.6)]">
              <path d="M21 2L26 14L38 8L30 22H12L4 8L16 14L21 2Z" fill="transparent" stroke="#C9A14A" strokeWidth="1.5" />
              <rect x="10" y="24" width="22" height="4" rx="2" fill="transparent" stroke="#C9A14A" strokeWidth="1.5" />
            </svg>
            <div className="flex items-center gap-6">
              <div className="w-16 h-px bg-gradient-to-r from-transparent to-[#C9A14A]"></div>
              <span className="text-[#C9A14A] tracking-[0.4em] uppercase text-sm font-semibold">The Stellaar</span>
              <div className="w-16 h-px bg-gradient-to-l from-transparent to-[#C9A14A]"></div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="w-24 h-px bg-gradient-to-r from-transparent to-[#C9A14A]/60"></div>
            <div className="w-2 h-2 rotate-45 border border-[#C9A14A]"></div>
            <div className="w-24 h-px bg-gradient-to-l from-transparent to-[#C9A14A]/60"></div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16 w-full">
            <Link
              href="/contact"
              className="group flex items-center justify-center gap-3 bg-[#C9A14A] text-black px-8 py-4 rounded-xl font-semibold uppercase tracking-widest text-sm hover:scale-105 hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] transition-all duration-300 w-full sm:w-auto"
            >
              Book a Visit
            ...
            <Link
              href="/amenities"
              className="group flex items-center justify-center gap-3 border border-[#C9A14A] text-white px-8 py-4 rounded-xl font-semibold uppercase tracking-widest text-sm hover:bg-[#C9A14A] hover:text-black transition-all duration-300 w-full sm:w-auto"
            >
          ...
          <div className="hidden lg:grid grid-cols-4 w-full border-t border-white/10 pt-10">
            {[
              { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#C9A14A" strokeWidth="1.5" className="mb-4 mx-auto"><path d="M2 20h20M5 20V9l4 4 3-8 3 8 4-4v11" /></svg>, text: "EXCLUSIVE PRIVATE CLUB" },
              { icon: <Gem className="w-7 h-7 text-[#C9A14A] mb-4 mx-auto stroke-[1.5]" />, text: "WORLD CLASS HOSPITALITY" },
              { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#C9A14A" strokeWidth="1.5" className="mb-4 mx-auto"><path d="M12 2C12 2 5 6 5 12C5 18 12 22 12 22C12 22 19 18 19 12C19 6 12 2 12 2Z" /><path d="M12 22V12" /></svg>, text: "WELLNESS FOR LIFE" },
              { icon: <Shield className="w-7 h-7 text-[#C9A14A] mb-4 mx-auto stroke-[1.5]" />, text: "CURATED FOR DISTINGUISHED FAMILIES" }
            ].map((feature, i) => (
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
          <div className="w-10 h-10 rounded-full border border-[#C9A14A]/40 flex items-center justify-center group cursor-pointer hover:border-[#C9A14A] transition-all">
            <ChevronDown className="w-5 h-5 text-[#C9A14A]/70 group-hover:text-[#C9A14A] group-hover:translate-y-1 transition-all duration-300" />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={i} className="space-y-2">
                <div className="text-4xl md:text-5xl font-serif text-[#C9A14A]">{stat.value}</div>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative h-[280px] sm:h-[380px] md:h-[550px] overflow-hidden">
              ...
              />
              {/* Gold accent frame */}
              <div className="absolute top-4 left-4 w-24 h-24 border-l-2 border-t-2 border-[#C9A14A]/60"></div>
              <div className="absolute bottom-4 right-4 w-24 h-24 border-r-2 border-b-2 border-[#C9A14A]/60"></div>
            </div>
            <div className="space-y-8">
              <p className="text-[#C9A14A] tracking-[0.3em] uppercase text-xs font-bold">Our Story</p>
              <h2 className="text-4xl md:text-5xl font-serif text-white leading-snug">The Vision Behind <span className="text-[#C9A14A]">The Stellaar</span></h2>
              ...
              <Link href="/amenities" className="inline-flex items-center gap-3 text-[#C9A14A] hover:text-white transition-all uppercase tracking-widest text-sm font-semibold group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          <div className="relative h-[220px] sm:h-[280px] md:h-[500px] overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-black/50 group-hover:bg-black/20 transition-colors duration-700 flex items-end p-8">
              <div>
                <div className="text-[#C9A14A] text-xs uppercase tracking-widest mb-2">Wellness</div>
          ...
          <div className="relative h-[220px] sm:h-[280px] md:h-[500px] overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-black/50 group-hover:bg-black/20 transition-colors duration-700 flex items-end p-8">
              <div>
                <div className="text-[#C9A14A] text-xs uppercase tracking-widest mb-2">Culinary</div>
          ...
          <div className="relative h-[220px] sm:h-[280px] md:h-[500px] overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-black/50 group-hover:bg-black/20 transition-colors duration-700 flex items-end p-8">
              <div>
                <div className="text-[#C9A14A] text-xs uppercase tracking-widest mb-2">Fitness</div>
      ...
      <section className="py-24 px-6 bg-[#0A0A0A] relative overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#C9A14A]/40 to-transparent"></div>
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-20">
            <h4 className="flex items-center justify-center gap-4 text-[#C9A14A] tracking-[0.2em] uppercase text-xs font-bold mb-6">
              <span className="w-8 h-[1px] bg-[#C9A14A]"></span> Our Pillars <span className="w-8 h-[1px] bg-[#C9A14A]"></span>
            </h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16">
            {[
              { icon: <Heart className="w-6 h-6 text-[#C9A14A]" />, title: "Fun for the Whole Family", desc: "Environments where children can play in safe, enriching spaces, and couples can enjoy romantic evenings — all within our secure, premium walls." },
              { icon: <Gem className="w-6 h-6 text-[#C9A14A]" />, title: "Experiences Beyond Compare", desc: "From world-class fitness centers and temperature-controlled pools to fine dining experiences that rival the best global restaurants." },
              { icon: <Eye className="w-6 h-6 text-[#C9A14A]" />, title: "Inspired By Elegance", desc: "Our properties are wonderfully in-tune with luxury aesthetics — a harmonious blend of the architecturally impressive with the meticulously curated." },
              { icon: <Award className="w-6 h-6 text-[#C9A14A]" />, title: "Sustainable Future", desc: "Committed to sustainable luxury, ensuring that our development leaves a positive impact on both the community and the environment." },
              { icon: <Star className="w-6 h-6 text-[#C9A14A]" />, title: "Luxury Bespoke Amenities", desc: "Every expectation will be met with our meticulous eye for detail, matching outstanding levels of craftsmanship and master building." },
              { icon: <Shield className="w-6 h-6 text-[#C9A14A]" />, title: "Strict Exclusivity", desc: "By capping our membership to just 100 families, we ensure zero crowding, maximum privacy, and instantly available amenities — always." },
            ].map((item, i) => (
              <div key={i} className="flex flex-col border-t border-[#C9A14A]/20 pt-6 group hover:border-[#C9A14A]/60 transition-colors duration-300">
                <div className="mb-4">{item.icon}</div>
                <h3 className="text-xl font-serif text-white mb-4 group-hover:text-[#C9A14A] transition-colors">{item.title}</h3>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 order-2 lg:order-1">
              <p className="text-[#C9A14A] tracking-[0.3em] uppercase text-xs font-bold">Community</p>
              <h2 className="text-4xl md:text-5xl font-serif text-white leading-snug">A Home Away <span className="text-[#C9A14A]">From Home</span></h2>
              <div className="space-y-5 text-white/60 font-light text-base leading-relaxed">
                <p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 pt-4">
                <div className="flex items-start gap-4">
                  <CheckCircle className="w-5 h-5 text-[#C9A14A] shrink-0 mt-0.5" />
            ...
            <div className="relative h-[280px] sm:h-[380px] md:h-[550px] overflow-hidden order-1 lg:order-2">
              <img
                ...
                className="w-full h-full object-cover"
              />
              <div className="absolute top-4 right-4 w-24 h-24 border-r-2 border-t-2 border-[#C9A14A]/60"></div>
              <div className="absolute bottom-4 left-4 w-24 h-24 border-l-2 border-b-2 border-[#C9A14A]/60"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-5xl text-center">
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-16">
            <div className="text-center">
              <div className="text-4xl font-serif text-[#C9A14A] mb-2">170+</div>
      ...
      <section className="py-16 md:py-28 px-4 md:px-8 bg-black text-center relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          <p className="text-[#C9A14A] tracking-[0.3em] uppercase text-xs font-bold mb-6">Join the Circle</p>
          <h2 className="text-3xl md:text-5xl font-serif text-white mb-8">Ready to Experience <span className="text-[#C9A14A]">The Stellaar?</span></h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/apply" className="inline-flex items-center gap-3 px-10 py-4 bg-[#C9A14A] text-black font-semibold hover:bg-white transition-colors uppercase tracking-widest text-sm shadow-[0_0_20px_rgba(212,175,55,0.2)]">
